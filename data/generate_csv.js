...
function generateLine(json){
  return json.district_code + "," + json.absolute_efficiency_gap + "," + json.state_efficiency_gap + "," + json.district_efficiency_gap + "," + json.absolute_compactness + "," + json.state_compactness + "," + json.district_compactness + "," + json.affiliation + "," + json.gerrymander_score + "," + json.rep;
}

addLine("district_code,absolute_efficiency_gap,state_efficiency_gap,district_efficiency_gap,absolute_compactness,state_compactness,district_compactness,affiliation,gerrymander_score,rep");
...
curl.request({
  ...
  for(var i = 0; i < representatives.length; i++){
    ...
    if(current_term.type === "rep"){
      var json_parsed = {
        name: representatives[i].name.official_full,
  ...
  for(var j = 0; j < district_codes.length; j++){
    ...
    var line = generateLine({
      ...
      absolute_compactness: 0,
      state_compactness: 0,
      district_compactness: 0,
