...
district_codes = district_codes.sort(function(a,b){
...
var geographical_compactness, geojson, area, perimeter, polsbypopper, area_of_circle;
...
for(var i = 0; i < 435; i++){
  ...
  area_of_circle = Math.PI * (perimeter / (2 * Math.PI))^2;

  //Polsby Popper
  polsbypopper = area / area_of_circle; //Ratio of area to area of circle with same perimeter (the larger, the more compact)
